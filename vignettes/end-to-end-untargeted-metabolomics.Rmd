...
vignette: >
  %\VignetteIndexEntry{A Complete End-to-End Workflow for untargeted LC-MS/MS Metabolomics Data Analysis in R}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding[utf8]{inputenc}
  %\VignettePackage{metabonaut}
---
...
data from the MetaboLights database, refer to the [vignette](https://rformassspectrometry.github.io/MsIO/articles/MsIO.html#Loading-data from-MetaboLights). 
...
sampleData(data)[, c("Derived_Spectral_Data_File", 
                     "Characteristics[Sample type]", 
                     "Factor Value[Phenotype]",
                     "Sample Name", "Factor Value[Age]")] |>
    as.data.frame() |>
    pandoc.table(style = "rmarkdown",
                 caption = "Table 1. Samples from the data set.")

# Let's rename the column for easier access
colnames(sampleData(data)) <- c("sample_name", "derived_spectra_data_file",
...
sampleData(data)$phenotype[sampleData(data)$sample_name == "POOL"] <- "QC"
sampleData(data)$sample_name[sampleData(data)$sample_name == "POOL" ] <- c("POOL1", "POOL2", "POOL3", "POOL4")

#  Add injection index column
sampleData(data)$injection_index <- seq_len(nrow(sampleData(data)))

#let's look at the updated sample data
sampleData(data)[, c("derived_spectra_data_file", 
...
```{r compare-spectra, eval=FALSE, include=FALSE}
...
# Add fragmentation data information 
